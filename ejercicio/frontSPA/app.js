...
function newBookPage() {
  ...
  content +=
    '<form id="formBook"><input type="text" name="isbn" placeholder="ISBN" id="isbn"><input type="text" name="title" id="title" placeholder="Título"><button type="submit" value="Enviar" id="btnNewBook">Enviar</button></form>';
  return content;
}

function booksPage() {
  content =
    '<h1>Libros</h1><br/><button id="linkNewBook">Nuevo libro</button><br/>';
  content +=
    '<table border="1"><tr><th>ISBN</th><th>Título</th><th>Eliminar</th></tr>';
